...
# insert picture
user_label = Label(root, image=scissor_img, bg="#00FFFF")
comp_label = Label(root, image=scissor_img_comp, bg="#00FFFF")
comp_label.grid(row=1, column=0)
user_label.grid(row=1, column=4)


# scores
playerScore = Label(root, text=0, font=100, bg="#00FFFF", fg="black")
computerScore = Label(root, text=0, font=100, bg="#00FFFF", fg="black")
computerScore.grid(row=1, column=1)
playerScore.grid(row=1, column=3)

# indicators
user_indicator = Label(root, font=50, text="USER", bg="#00FFFF", fg="black")
...
# messages
msg = Label(root, font=50, bg="#00FFFF", fg="black")
...
scissor = Button(root, width=20, height=2, text="SCISSOR",
                 bg="#9b59b6", fg="black", command=lambda: updateChoice("scissor")).grid(row=2, column=3)
